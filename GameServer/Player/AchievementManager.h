...
enum ePlayerProgress
{
    ...
    PLAYER_PROGRESS_PUT_OUT_FIRE_COUNT,
    PLAYER_PROGRESS_PET_1_0,
    PLAYER_PROGRESS_PET_1_1,
    PLAYER_PROGRESS_PET_1_2,
    PLAYER_PROGRESS_PET_2_0,
    PLAYER_PROGRESS_PET_2_1,
    PLAYER_PROGRESS_PET_2_2,
    PLAYER_PROGRESS_ONLINE_STATUS,
    PLAYER_PROGRESS_TITLES,
    PLAYER_PROGRESS_ACTIVE_TITLES,
